...
from napoleonai.textclassification.common.common_types import GensimEmbeddingLayerGenerator, Vocabulary
from napoleonai.settings import DEFAULT_WORD2VEC_WINDOW_SIZE, DEFAULT_WORD2VEC_MIN_COUNT, DEFAULT_NO_WORKERS, \
