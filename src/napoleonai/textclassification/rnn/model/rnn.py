...
from napoleonai.settings import DEFAULT_RNN_MODEL_NAME, DEFAULT_TEXT_INPUT_RAW_SUFFIX, DEFAULT_TEXT_ENCODING_LAYER_SUFFIX, \
    DEFAULT_EMBEDDING_LAYER_SUFFIX, DEFAULT_RNN_LAYER_NAME, DEFAULT_FEATURES_LAYER_NAME
from napoleonai.textclassification.common.classifier import create_classifier
from napoleonai.textclassification.common.common_types import Vocabulary
...
def get_rnn_for_text_classification(
    ...
    :param pretrained_word_embeddings: Embedding layer + Vocabulary, the function will use these pretrained word embeddings, None, otherwise
    ...
    :param rnn_layers_sizes: list of int, the sizes of each bidirectional rnn layer !!! For list [1, 2, 3] the number of parameters for each layer is [2, 4, 6], because it is bidirectional !!!
